...
var messages = struct {
	...
	passTest:  &message{" -- PASS %s \xf0\x9f\x97\xb8 (%.2fs)\n", "\x1b[36m -- \x1b[32mPASS %s \xf0\x9f\x97\xb8 (%.2fs)\x1b[0m\n"},
	failTest:  &message{" -- FAIL %s \xc3\x97 (%.2fs)\n", "\x1b[36m -- \x1b[31mFAIL %s \xc3\x97 (%.2fs)\x1b[0m\n"},
